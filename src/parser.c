...
AST_T* parser_parse_statement(parser_T* parser, scope_T* scope)
{
    ...
    {
        case TOKEN_KEYWORD: return parser_parse_id(parser, scope);
    }
...
AST_T* parser_parse_variable_definition(parser_T* parser, scope_T* scope)
{
    ...
    parser_eat(parser, TOKEN_KEYWORD); // var name
...
AST_T* parser_parse_function_definition(parser_T* parser, scope_T* scope)
{
    ...
    parser_eat(parser, TOKEN_KEYWORD); // function name
...
AST_T* parser_parse_variable(parser_T* parser, scope_T* scope)
{
    ...
    parser_eat(parser, TOKEN_KEYWORD); // var name or function call name
